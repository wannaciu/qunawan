...
public class CodeAction {
    ...
    @RequestMapping("/check_code.jhtml")
    @ResponseBody
    public  String check_code(HttpServletRequest request){
        String code = request.getParameter("code");
        System.out.println("输入的码:"+code);
        if(code == null)
            return "false";
        String nCode = (String)request.getSession().getAttribute("identify_code");
        System.out.println("真实的码:"+nCode);
        if(nCode == null)
            return "false";
